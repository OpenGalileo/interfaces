...
*/
int Bosch_Imu::imu_init(OperModes op_mode, PowerModes pwr_mode, I2C_HandleTypeDef *handle){
    hi2c = handle; 
    uint8_t buf[10] = {0};
...
*/
int Bosch_Imu::imu_init(OperModes op_mode, PowerModes pwr_mode, I2C_HandleTypeDef *handle, uint8_t alt_addr){
    DEV_ADDR = alt_addr<<1; 
    hi2c = handle; 
